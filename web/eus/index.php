...
<body>
	    ...
	    <div class="carousel-inner">
	        <div class="item active">
	            ...
	            <div class="carousel-caption">
	                <h3>"FROM THIS DAY TO THE GRAVE" DAGOENEKO ESKURAGARRI</h3>
	                <a href="http://localhost/meltdown2.0/web/eng/store.html"><p>Klikatu hemen zurea eskuratzeko</p></a>
	            </div>
	        </div>
	        ...
	        <div class="item">
	            ...
	            <div class="carousel-caption">
	                ...
	                <a href="http://localhost/meltdown2.0/web/es/tourdates.php"><p>Kontzertu data gehiago...</p></a>
	            </div>
	        </div>
	...
	<div class="div_comming_shows">
		<img class="img_comming_shows center-block" alt="" src="../img/conciertos/eusk/proximos_conciertos.png"/>
