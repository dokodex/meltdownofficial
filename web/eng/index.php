...
<body>
	    ...
	    <div class="carousel-inner">
	        <div class="item active">
	            ...
	            <div class="carousel-caption">
	                <h3>"FROM THIS DAY TO THE GRAVE" OUT NOW</h3>
	                <a href="http://localhost/meltdown2.0/web/eng/store.html"><p>Click here to get your album</p></a>
	            </div>
	        </div>
	        ...
	        <div class="item">
	            ...
	            <div class="carousel-caption">
	                ...
	                <a href="http://localhost/meltdown2.0/web/eng/tourdates.php"><p>More tour dates...</p></a>
	            </div>
	        </div>
	...
	<div class="div_comming_shows">
		<img class="img_comming_shows center-block" alt="" src="../img/conciertos/ing/coming_shows.png"/>
